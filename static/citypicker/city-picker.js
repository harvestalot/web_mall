...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    '<span id="reset_city" class="reset_city fr"></span>' +'</div>' +
        ...
        bind: function () {
            ...
            //重置城市插件
            this.$dropdown.on('click', '#reset_city', function () {
                $this.reset();
            });
        ...
        simplize: function (address, type) {
            ...
            if (type === PROVINCE) {
                ...
                return address.replace(/[市,地区,回族,蒙古,苗族,傣族,颇族,藏族,彝族,壮族,傈僳族,依族,侗族]/g, '')
                    .replace('哈萨克', '').replace('自治州', '').replace(/自治县/, '');
            } else if (type === DISTRICT) {
                return address.length > 2 ? address.replace(/自治县/, '') : address;
            }
        },
